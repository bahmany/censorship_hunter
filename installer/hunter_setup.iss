...
Source: "{#MyStagingDir}\runtime\HUNTER_config_db_export.txt"; DestDir: "{app}\runtime"; Flags: onlyifdoesntexist skipifsourcedoesntexist
Source: "{#MyStagingDir}\runtime\sources_manager.tsv"; DestDir: "{app}\runtime"; Flags: onlyifdoesntexist skipifsourcedoesntexist
Source: "{#MyStagingDir}\runtime\source_history.tsv"; DestDir: "{app}\runtime"; Flags: onlyifdoesntexist skipifsourcedoesntexist
